...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->buscadorClienteBTN->Click += gcnew System::EventHandler(this, &VISTAempleadosFAC::buscadorClienteBTN_Click);
			// 
			// NOM
			// 
			...
			this->buscarProBTN->Click += gcnew System::EventHandler(this, &VISTAempleadosFAC::buscarProBTN_Click);
			// 
			// CodigoBarraTBX
			// 
			...
			this->calcularBTN->Click += gcnew System::EventHandler(this, &VISTAempleadosFAC::calcularBTN_Click);
			// 
			// label7
			// 
			...
			this->agregarBTN->Click += gcnew System::EventHandler(this, &VISTAempleadosFAC::agregarBTN_Click);
			// 
			// button2
			// 
			...
			this->button2->Click += gcnew System::EventHandler(this, &VISTAempleadosFAC::modificarBTN_Click);
			// 
			// button3
			// 
			...
			this->Load += gcnew System::EventHandler(this, &VISTAempleadosFAC::VISTAempleadosFAC_Load);
...
private: System::Void VISTAempleadosFAC_Load(System::Object^ sender, System::EventArgs^ e) {
