...
void FACPelisvistas::VISTAempleadosFAC::buscadorClienteBTN_Click(System::Object^ sender, System::EventArgs^ e) {
...
void FACPelisvistas::VISTAempleadosFAC::buscarProBTN_Click(System::Object^ sender, System::EventArgs^ e) {
...
void FACPelisvistas::VISTAempleadosFAC::calcularBTN_Click(System::Object^ sender, System::EventArgs^ e) {
...
void FACPelisvistas::VISTAempleadosFAC::agregarBTN_Click(System::Object^ sender, System::EventArgs^ e) {
...
void FACPelisvistas::VISTAempleadosFAC::cargarVentas() {
	try {
		if (!BDDins || BDDins->isClosed()) {
			conexionCls temp("", "", "", "", "", "", "", "", "", "", "");
			temp.conectVoid();
...
void FACPelisvistas::VISTAempleadosFAC::modificarBTN_Click(System::Object^ sender, System::EventArgs^ e) {
